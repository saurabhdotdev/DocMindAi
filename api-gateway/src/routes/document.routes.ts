...
router.get('/:id/action-items', authenticateJWT, DocumentController.getActionItems);
router.patch('/:id/action-items/:itemId', authenticateJWT, DocumentController.toggleActionItem);
